...
import SortedTooltip from "./SortedTooltip";
import ShiftedLine from "./ShiftedLine";

import prepareQuarterlyRows from "./PrepareQuarterlyRows";
import createSeriesRenderers from "./CreateSeriesRenderers";
...
const ExpandableQuarterlyAnalysisChart = ({
  ...
  const ExpandedChartContent = () => {
    ...
    const { main } = createSeriesRenderers({
      ...
      mode: expandedMode,
      metricSuffix,
      showLabelsEnabled: expandedShowLabels,
      isExpandedView: true,
      chartDims: dims,
  ...
  const ChartContent = ({
    ...
    const dims = getChartDims(isExpandedView, undefined, isExpandedView ? EXPANDED_CHART_MARGIN : CHART_MARGIN);
    ...
    const { main: leftMain } = createSeriesRenderers({
      ...
      mode: leftModeState,
      metricSuffix: "volume",
      showLabelsEnabled: showLabelsState,
      isExpandedView,
      chartDims: dims,
      shouldFullyLabelLines,
      latestYear,
