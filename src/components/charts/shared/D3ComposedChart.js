...
const D3ComposedChart = ({
    ...
    if (mode === 'column') {
      ...
      g.append('rect')
        ...
        .on('mousemove', function(event) {
          ...
          const year = Math.round(xScale.invert ? xScale.invert(mouseX) : 
  ...
  }, [data, categories, mode, width, height, margin, strokeWidth, gridColor, axisColor, yAxisLabel, colorOf, dataKeySuffix, tooltipFormatter]);
